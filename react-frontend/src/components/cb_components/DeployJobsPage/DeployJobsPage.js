...
const DeployJobsPage = (props) => {
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("deployJobs").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
