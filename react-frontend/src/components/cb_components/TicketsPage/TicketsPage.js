  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          reporter: urlParams.singleUsersId,
          assignee: urlParams.singleUsersId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Tickets",
          type: "error",
          message: error.message || "Failed get Tickets",
        });
      });
