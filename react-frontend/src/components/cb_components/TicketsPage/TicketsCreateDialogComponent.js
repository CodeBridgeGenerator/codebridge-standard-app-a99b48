...
const TicketsCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    try {
      ...
      const eagerResult = await client.service("tickets").find({
        query: {
          $limit: 10000,
          _id: { $in: [result._id] },
          $populate: [
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Tickets updated successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Tickets",
      });
    }
    setLoading(false);
  };
  ...
  const reporterOptions = reporter.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const assigneeOptions = assignee.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="tickets-create-dialog-component"
      >
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <InputText
              ...
              value={_entity?.ticket}
              onChange={(e) => setValByKey("ticket", e.target.value)}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <InputText
              id="project"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.project}
              onChange={(e) => setValByKey("project", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <InputText
              id="priority"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.priority}
              onChange={(e) => setValByKey("priority", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <Dropdown
              id="reporter"
              value={_entity?.reporter?._id}
              optionLabel="name"
              optionValue="value"
              options={reporterOptions}
              onChange={(e) => setValByKey("reporter", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <Dropdown
              id="assignee"
              value={_entity?.assignee?._id}
              optionLabel="name"
              optionValue="value"
              options={assigneeOptions}
              onChange={(e) => setValByKey("assignee", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <InputText
              id="closed"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.closed}
              onChange={(e) => setValByKey("closed", e.target.value)}
            />
          </span>
          <small className="p-error">
