...
const TicketsDataTable = ({
  ...
  const dropdownTemplate7 = (rowData, { rowIndex }) => (
    <p>{rowData.reporter?.null}</p>
  );
  const dropdownTemplate8 = (rowData, { rowIndex }) => (
    <p>{rowData.assignee?.name}</p>
  );
    ...
    <>
      ...
      >
        <Column
          ...
          header="Ticket"
          body={pTemplate0}
          filter={selectedFilterFields.includes("ticket")}
          hidden={selectedHideFields?.includes("ticket")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="Project"
          body={pTemplate1}
          filter={selectedFilterFields.includes("project")}
          hidden={selectedHideFields?.includes("project")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          header="Priority"
          body={pTemplate5}
          filter={selectedFilterFields.includes("priority")}
          hidden={selectedHideFields?.includes("priority")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="type"
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("reporter")}
          hidden={selectedHideFields?.includes("reporter")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="assignee"
          ...
          filter={selectedFilterFields.includes("assignee")}
          hidden={selectedHideFields?.includes("assignee")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="closed"
          header="Closed"
          body={pTemplate9}
          filter={selectedFilterFields.includes("closed")}
          hidden={selectedHideFields?.includes("closed")}
          sortable
          style={{ minWidth: "8rem" }}
        />
